...
% 请根据你实际的文件名修改这里
load('/Users/jihao/MUUFLGulfport-master/MUUFLGulfport-master/MUUFLGulfportDataCollection/muufl_gulfport_campus_w_lidar_1.mat'); % 假设加载后工作区里有 hsi 这个结构体
load('/Users/jihao/MUUFLGulfport-master/MUUFLGulfport-master/MUUFLGulfportDataCollection/tgt_img_spectra.mat'); % 加载那 4 个官方纯净光谱
...
% =========================================================
% 【新增】：在裁剪前，把全图的 Point 级真值重塑为 2D 图像保存！
% 这样你在做 ACE 全图检测时，就能直接用这个变量画左边的 Ground Truth 图了
gt_mask_2d = reshape(labels_point, rows, cols); 
% =========================================================
...
%% 8. 保存文件！
disp('正在保存数据...');
save('positive_gulfport1.mat', 'positive');
save('negative_gulfport1.mat', 'negative');
save('E_t_gulfport1.mat', 'E_t');
% save('ground_truth_gulfport.mat', 'labels_point', "labels_bag");
% 【新增】：把 gt_mask_2d 一起存进去
save('ground_truth_gulfport1.mat', 'labels_point', 'labels_bag', 'gt_mask_2d');
