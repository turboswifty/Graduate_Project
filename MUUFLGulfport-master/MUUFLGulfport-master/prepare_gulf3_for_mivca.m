...
% 请根据你实际的文件名修改这里
load('/Users/jihao/MUUFLGulfport-master/MUUFLGulfport-master/MUUFLGulfportDataCollection/muufl_gulfport_campus_3.mat'); % 假设加载后工作区里有 hsi 这个结构体
...
%% 8. 保存文件！
disp('正在保存数据...');
save('positive_gulfport3.mat', 'positive');
save('negative_gulfport3.mat', 'negative');
save('E_t_gulfport3.mat', 'E_t');
% save('ground_truth_gulfport.mat', 'labels_point', "labels_bag");
% 【新增】：把 gt_mask_2d 一起存进去
save('ground_truth_gulfport3.mat', 'labels_point', 'labels_bag', 'gt_mask_2d');
