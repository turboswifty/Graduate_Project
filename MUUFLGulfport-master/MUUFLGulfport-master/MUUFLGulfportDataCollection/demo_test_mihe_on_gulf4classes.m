...
load end_mihe_gulfport_all.mat;
...
if USE_IMAGE_SPECTRA
    ...
    target_sigs = cell2mat(E_mihe_all);
...
save('Figure103_mihe_ROC_data.mat', '-struct', 'roc_data');
disp('已保存: Figure103_mihe_ROC_data.mat');

% 同时保存原始 score cell，方便后续直接用 PlotBullwinkleRoc 重画
save('Figure103_mihe_score_backup.mat', 'score');
disp('已备份 score 结构: Figure103_mihe_score_backup.mat');