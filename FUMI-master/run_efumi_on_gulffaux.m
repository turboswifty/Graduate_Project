...
disp('正在加载数据集...');
% 加载正负包数据
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/positive_gulfport_faux_vineyard_green.mat');
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/negative_gulfport_faux_vineyard_green.mat');
% 加载标签 (里面有 labels_bag 和 labels_point)
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/ground_truth_gulfport_faux_vineyard_green.mat'); 
% 加载真实的红板岩端元 (注意你的文件名是 E_tjh)
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/E_t_gulfport_faux_vineyard_green.mat'); 
...
save('end_efumi_gulfport_faux_vineyard_green.mat', "E_efumi_target")

%% 7. 加载你的 MIVCA 结果做终极对比 (假设你之前存了 end04.mat)
try
    load('/Users/jihao/毕设相关/mean0.1/mean0.1/end04_gulfport_faux_vineyard_green.mat'); % 加载你的 E_vca on gulfport dark green
