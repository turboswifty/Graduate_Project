...
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/ground_truth_gulfport.mat'); 
% 加载真实的端元 
...
parameters_eFUMI.M = 16;         % 端元总数：1个目标 + 15个背景 = 16
...
save('end_efumi_gulfport.mat', "E_efumi_target")

%% 7. 加载你的 MIVCA 结果做终极对比 (假设你之前存了 end04.mat)
try
    load('/Users/jihao/毕设相关/mean0.1/mean0.1/end04_gulfport.mat'); % 加载你的 E_vca on gulfport
