...
disp('正在加载数据集...');
% 加载正负包数据
load('/Users/jihao/毕设相关/mean0.1/mean0.1/positivejh.mat'); 
load('/Users/jihao/毕设相关/mean0.1/mean0.1/negativejh.mat'); 
% 加载标签 (里面有 labels_bag 和 labels_point)
load('/Users/jihao/毕设相关/mean0.1/mean0.1/ground_truthjh.mat'); 
% 加载真实的红板岩端元 (注意你的文件名是 E_tjh)
load('/Users/jihao/毕设相关/mean0.1/E_tjh.mat'); 
...
parameters_eFUMI.M = 4;         % 端元总数：1个目标 + 3个背景 = 4
...
save('end_efumi.mat', "E_efumi_target")

%% 7. 加载你的 MIVCA 结果做终极对比 (假设你之前存了 end04.mat)
try
    load('end04.mat'); % 加载你的 E_vca
    ...
    plot(1:211, E_t_plot, 'r-', 'LineWidth', 2); hold on;
    plot(1:211, E_efumi_plot, 'g--', 'LineWidth', 2);
    plot(1:211, E_vca_plot, 'b-.', 'LineWidth', 2);
