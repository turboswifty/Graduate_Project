...
disp('正在加载数据集...');
% 加载正负包数据
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/archive/positive_pavia.mat');
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/archive/negative_pavia.mat');
% 加载标签 (里面有 labels_bag 和 labels_point)
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/archive/ground_truth_pavia.mat'); 
% 加载真实的端元 
load('/Users/jihao/毕设相关/HyperspectralAnalysisIntroduction-0.3/archive/E_t_pavia.mat'); 
...
parameters_eFUMI.u = 0.01;
parameters_eFUMI.M = 4;         % 端元总数：1个目标 + 15个背景 = 16
parameters_eFUMI.gammaconst = 2;
parameters_eFUMI.beta = 0.01;
parameters.iterationCap = 500;
...
save('end_efumi_pavia.mat', "E_efumi_target")

%% 7. 加载你的 MIVCA 结果做终极对比 (假设你之前存了 end04.mat)
try
    load('/Users/jihao/毕设相关/mean0.1/mean0.1/end04_pavia_mivca.mat'); % 加载你的 E_vca on gulfport
    ...
    plot(1:103, E_t_plot, 'r-', 'LineWidth', 2); hold on;
    plot(1:103, E_efumi_plot, 'g--', 'LineWidth', 2);
    plot(1:103, E_vca_plot, 'b-.', 'LineWidth', 2);
